      ...
      <div className='flex flex-1'>
        ...
        <aside className='w-64 bg-gray-800 p-4 text-white'>
          ...
          <nav className='space-y-2'>
            <Link href='/chief' className='block rounded px-4 py-2 hover:bg-gray-700'>
              Dashboard
            </Link>
            <Link href='/chief/orders' className='block rounded px-4 py-2 hover:bg-gray-700'>
              Orders
            </Link>
            <Link href='/chief/products' className='block rounded px-4 py-2 hover:bg-gray-700'>
              Products
            </Link>
            <SignOut />
          </nav>
